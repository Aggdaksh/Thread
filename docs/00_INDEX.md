...
Single entry point for project documentation. Render deployment does **not** use Docker; the frontend can be deployed as a static app on Vercel or Render.
...
| Doc | Description |
|-----|-------------|
| [deploy/VERCEL_FRONTEND_RENDER_BACKEND.md](deploy/VERCEL_FRONTEND_RENDER_BACKEND.md) | **Live-URL style deployment:** Vercel frontend + Render backend |
